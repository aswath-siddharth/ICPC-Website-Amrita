            ...
            <div className="min-w-[80vw] max-md:min-w-[90vw]">
                ...
                <div className="mt-[3vw] flex flex-col max-md:items-center">
                    <div className="max-md:w-[90vw]">
                        <p className="font-semibold text-[3vw] max-md:text-[6vw]">Team Rank List</p>
                        <p className="text-[1.2vw] -mt-[0.5vw] max-md:text-[4vw]">Click to download the pdf containing the team rank list.</p>
                    </div>
                    <div className="flex pt-[1vw] flex-wrap max-w-[83vw] max-md:max-w-[90vw] max-md:justify-center max-md:w-[90vw]">
                        <a href="/data/Rank_List.pdf" download className="rounded-[1vw] shadow-[0_0px_20px_rgba(0,_0,_0,_0.7)] max-md:shadow-[0_0px_13px_rgba(0,_0,_0,_0.7)] hover:text-blue-500 max-md:mt-[5vw]">
                            <Image 
                                    src="/rank-list.png" 
