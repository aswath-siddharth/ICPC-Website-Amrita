...
import { Users, Eye, Briefcase, Star, Building2, Globe } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      desc: 'Direct access to India’s best programmers, innovators, and problem solvers.',
      icon: <Users className="w-7 h-7 text-[#3A84C3]" />,
    },
    {
      title: 'Unmatched Visibility',
      desc: 'Brand exposure to 50,000+ highly skilled programmers and tech enthusiasts.',
      icon: <Eye className="w-7 h-7 text-[#3A84C3]" />,
    },
    {
      title: 'Recruitment Advantage',
      desc: 'Stand out as a preferred employer by connecting early with elite contestants.',
      icon: <Briefcase className="w-7 h-7 text-[#3A84C3]" />,
    },
    {
      title: 'Prestige & Association',
      desc: 'Partner with the world’s most prestigious competitive programming contest.',
      icon: <Star className="w-7 h-7 text-[#3A84C3]" />,
    },
    {
      title: 'Onsite Branding',
      desc: 'Brand placement across banners, booths, jackets, media, and event kits.',
      icon: <Building2 className="w-7 h-7 text-[#3A84C3]" />,
    },
    {
      title: 'Global Recognition',
      desc: 'Benefit from ICPC’s international reach with global academic visibility.',
      icon: <Globe className="w-7 h-7 text-[#3A84C3]" />,
    },
  ];

  return (
    <section className="relative bg-gradient-to-b from-[#F4F9FF] via-white to-[#F4F9FF] px-6 md:px-12 lg:px-24 py-20 text-gray-900 overflow-hidden">

      {/* ICPC Color Accent Background Shapes */}
      <div className="absolute top-0 left-0 w-[35vw] h-[35vw] bg-[#3A84C3]/10 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-0 right-0 w-[30vw] h-[30vw] bg-[#F7C948]/20 rounded-full blur-3xl -z-10" />
      ...
      >
        <h2 className="text-[#3A84C3] uppercase tracking-wider text-sm font-semibold mb-3">
          Why Sponsor Us
        </h2>

        <h1 className="text-4xl md:text-5xl font-extrabold mb-4 
          bg-gradient-to-r from-[#0C1E46] via-[#3A84C3] to-[#0C1E46] 
          bg-clip-text text-transparent leading-tight">
          Why Sponsor ICPC Amritapuri 2025?
        </h1>

        <p className="text-gray-600 text-lg max-w-3xl mx-auto">
          Sponsoring ICPC Amritapuri gives your brand direct access to India’s brightest minds 
          and future tech leaders while enhancing your visibility across academia and industry.
        </p>
      </motion.div>
      ...
      >
        {benefits.map((b, i) => (
          <motion.div
            ...
            className="p-6 bg-white/90 backdrop-blur-md border border-[#E5F0FA] 
                       rounded-2xl shadow-sm hover:shadow-xl hover:border-[#3A84C3]/40 
                       transition-all duration-300 group"
          >
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 bg-[#E7F2FF] rounded-full group-hover:bg-[#D9EAFF] transition">
                {b.icon}
              </div>

              <h3 className="text-lg font-bold text-[#0C1E46]">
                {b.title}
              </h3>
            </div>
      ...
      >
        <h3 className="text-xl font-semibold text-[#0C1E46] mb-4">
          Ready to collaborate with ICPC Amritapuri?
        </h3>

        <button className="px-10 py-3.5 rounded-full bg-gradient-to-r 
          from-[#3A84C3] to-[#0C1E46] text-white font-semibold shadow-md 
